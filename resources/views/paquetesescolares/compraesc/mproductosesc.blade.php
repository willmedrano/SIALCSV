...
<h4 class="modal-title" id="gridModalLabel3">ACTIVAR PRODUCTO</h4>
      ...
      <div class="modal-body">
        <div class="container-fluid bd-example-row">
          {!!Form::model($cat3,['method'=>'PATCH','route'=>['paquete.update',$cat3->id]])!!}
...
<h4 class="modal-title" id="gridModalLabel3" >Desactivar PRODUCTO</h4>
      ...
      <div class="modal-body">
        <div class="container-fluid bd-example-row">
           {!!Form::model($cat2,['method'=>'PATCH','route'=>['paquete.update',$cat2->id]])!!}
              <label for="">¿Seguro que desea cambiar el estado del producto?</label>
...
<h4 class="modal-title" id="gridModalLabel">Modificar Producto</h4>
      ...
      <div class="modal-body">
        <div class="container-fluid bd-example-row">
      {!!Form::model($cat,['method'=>'PATCH','route'=>['paquete.update',$cat->id]])!!}
      <fieldset>
...
<br>
                        <div class="form-group">
                            <span class="col-md-2  text-center"><label >paquete: </label></span>
                            <div class="col-md-6">
...
<br>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="gUni" name="gUni" type="hidden" placeholder="porcentaje por unidad" class="form-control" value="{{ $cat->gUni }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="uniCaja" name="uniCaja" type="hidden" placeholder="por caja " class="form-control" value="{{ $cat->uniCaja}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="gCaja" name="gCaja" type="hidden" placeholder="porcentaje por Caja" class="form-control" value="{{ $cat->gCaja }}">
                            </div>
